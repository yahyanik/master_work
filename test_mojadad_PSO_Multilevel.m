...
%             'PopInitRange',[0;1.6],'PopulationSize',2000,...
%             'mutationfcn',@mutationadaptfeasible,'TolCon',1e-10);
% %             'SelectionFcn',@garollet);
        options = optimoptions ( 'particleswarm','MaxIter',2000,'SwarmSize',1000);
        [tetha(:,(k)),f(:,(k))] = particleswarm(@fitness_ga_multilevel...
            ,7,LB,UB,options);
%         if j == 1
%             temp1 = tetha(:,(k));
%             temp = f(:,(k));
